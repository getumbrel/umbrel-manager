...
module.exports = {
  ...
  ELECTRUM_HIDDEN_SERVICE_FILE: process.env.ELECTRUM_HIDDEN_SERVICE_FILE || '/var/lib/tor/bitcoin-p2p/hostname',
  ELECTRUM_PORT: process.env.ELECTRUM_PORT || 50001,
  BITCOIN_P2P_HIDDEN_SERVICE_FILE: process.env.BITCOIN_P2P_HIDDEN_SERVICE_FILE || '/var/lib/tor/electrum/hostname',
