...
module.exports = {
  ...
  UPDATE_VERSION_FILE: process.env.UPDATE_VERSION_FILE || '/update/info.json',
  UPDATE_STATUS_FILE: process.env.UPDATE_STATUS_FILE || '/update/status.json',
  UPDATE_SIGNAL_FILE: process.env.UPDATE_SIGNAL_FILE || '/update/start-update',
  UPDATE_LOCK_FILE: process.env.UPDATE_LOCK_FILE || '/update/update-in-progress',
  STATUS_CODES: {
    ACCEPTED: 202,
    BAD_GATEWAY: 502,
    CONFLICT: 409,
